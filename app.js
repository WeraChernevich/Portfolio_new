...
var burgerOpen = document.querySelector('.nav-burger');
burgerOpen.addEventListener('click', openOnClick);
...
function openOnClick() {
  ...
  var burgerClose = document.querySelector('.mobile-nav__nav-burger.active');
  burgerClose.addEventListener('click', closeOnClick);

  function closeOnClick() {
    burgerClose.classList.remove('active');
    document.querySelector('.nav-burger.active').classList.remove('active');
    document.querySelector('.mobile-nav.open').classList.remove('open');
    document.querySelector('.mobile-nav-overlay.open').classList.remove('open');
    document.querySelector('.mobile-nav__nav.active').classList.remove('active');
    document.querySelector('.mobile-nav__nav-burger.active').classList.remove('active');
